...
const API_BASE = 'https://84ea5393-3b41-40f9-8bf8-65a1810f577b-00-364t60vf8hwby.riker.replit.dev/api/mobile';
...
export default function App() {
  ...
  const [deviceId, setDeviceId] = useState<string>('device_' + Math.random().toString(36).substring(7));
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.welcomeContainer}>
          ...
          <Text style={styles.welcomeSubtitle}>Faça seu pedido de forma rápida e prática</Text>
          ...
          {!tableNumber ? (
            ...
            <View style={styles.modeSelection}>
              ...
              >
                <Text style={styles.modeButtonTitle}>Rodízio</Text>
                <Text style={styles.modeButtonSubtitle}>Coma à vontade</Text>
              </TouchableOpacity>
              ...
              >
                <Text style={styles.modeButtonTitle}>À La Carte</Text>
                <Text style={styles.modeButtonSubtitle}>Escolha seus pratos</Text>
              </TouchableOpacity>
            </View>
          )}
              ...
              >
                ...
                <View style={styles.productInfo}>
                  ...
                  <Text style={styles.productPrice}>
                    {parseFloat(product.price) === 0 ? 'Incluso' : `R$ ${product.price}`}
                  </Text>
                </View>
              </TouchableOpacity>
            ))}
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <View style={styles.cartFooter}>
              <Text style={styles.cartTotal}>Total: R$ {getCartTotal().toFixed(2)}</Text>
              <TouchableOpacity
