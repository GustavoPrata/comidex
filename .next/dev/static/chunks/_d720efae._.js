...
function PrintersPage() {
    ...
    const loadPrinters = async ()=>{
        ...
        // All retries failed
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Erro ao carregar impressoras. Por favor, recarregue a página.");
        setLoading(false);
    };
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PrintersPage.useEffect": ()=>{
            const timer = setTimeout({
                "PrintersPage.useEffect.timer": ()=>{
                    loadPrinters();
                }
            }["PrintersPage.useEffect.timer"], 100);
            return ({
                "PrintersPage.useEffect": ()=>clearTimeout(timer)
            })["PrintersPage.useEffect"];
        }
    }["PrintersPage.useEffect"], []);
    ...
    const savePrinter = async ()=>{
        try {
            ...
            if (editingPrinter) {
                ...
                if (error) throw error;
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Impressora atualizada com sucesso!");
            } else {
                // Insert
                const { error } = await supabase.from('printers').insert(printerData);
                if (error) throw error;
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Impressora adicionada com sucesso!");
            }
            setIsModalOpen(false);
            loadPrinters();
        } catch (error) {
            console.error('Error saving printer:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Erro ao salvar impressora");
        } finally{
            setSaving(false);
        }
    };
    ...
    const handleDelete = async ()=>{
        ...
        try {
            ...
            if (error) throw error;
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Impressora excluída com sucesso!");
            setIsDeleteModalOpen(false);
            setDeletePrinter(null);
            loadPrinters();
        } catch (error) {
            console.error('Error deleting printer:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Erro ao excluir impressora");
        } finally{
            setSaving(false);
        }
    };
    ...
    const toggleActive = async (printer)=>{
        try {
            ...
            if (error) throw error;
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Impressora ${!printer.active ? 'ativada' : 'desativada'}`);
            loadPrinters();
        } catch (error) {
    ...
    const testPrinter = async (printer)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info(`Testando conexão com ${printer.name} (${printer.ip}:${printer.port})`);
        // In a real implementation, this would send a test print job
        setTimeout(()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Teste enviado para ${printer.name}`);
        }, 1500);
    };
    // Show loading state
    if (loading) {
...
_s(PrintersPage, "ZiRARZMFWOuY0p7JOtLj5MoF0hY=");
_c = PrintersPage;
var _c;
...
//# sourceMappingURL=_d720efae._.js.map