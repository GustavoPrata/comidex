...
function POSPage() {
    ...
    const handleCancelOrder = ()=>{
        if (cart.length === 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Carrinho já está vazio");
            return;
        }
        // Confirmação antes de cancelar
        if (confirm("Deseja realmente cancelar todos os itens do carrinho?")) {
            setCart([]);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Carrinho limpo com sucesso");
        }
    };
    const handleLaunchOrder = async ()=>{
        if (cart.length === 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Adicione itens ao carrinho primeiro");
            return;
        }
        if (!selectedTable?.id) {
    ...
    const handleSaveOrder = async ()=>{
        if (!currentSession || !selectedTable || cart.length === 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Adicione itens ao pedido");
            return;
        }
        setLoading(true);
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Pedido salvo com sucesso");
        } catch (error) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(`Erro ao salvar pedido: ${error?.message || 'Erro desconhecido'}`);
        } finally{
            setLoading(false);
        }
    };
