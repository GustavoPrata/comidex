...
function TablesPage() {
    ...
    const [isBatchModalOpen, setIsBatchModalOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const loadTables = async ()=>{
        ...
        // All retries failed
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Erro ao carregar mesas. Por favor, recarregue a página.");
        setLoading(false);
    };
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TablesPage.useEffect": ()=>{
            const timer = setTimeout({
                "TablesPage.useEffect.timer": ()=>{
                    loadTables();
                }
            }["TablesPage.useEffect.timer"], 100);
            return ({
                "TablesPage.useEffect": ()=>clearTimeout(timer)
            })["TablesPage.useEffect"];
        }
    }["TablesPage.useEffect"], []);
    ...
    const saveTable = async ()=>{
        try {
            ...
            if (editingTable) {
                ...
                if (error) throw error;
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Mesa atualizada com sucesso!");
            } else {
                // Insert
                const { error } = await supabase.from('restaurant_tables').insert(tableData);
                if (error) throw error;
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Mesa criada com sucesso!");
            }
            setIsModalOpen(false);
            loadTables();
        } catch (error) {
            console.error('Error saving table:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Erro ao salvar mesa");
        } finally{
            setSaving(false);
        }
    };
    ...
    const saveBatchTables = async ()=>{
        try {
            ...
            if (start > end) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Número inicial deve ser menor que o final");
                return;
            }
            const newTables = [];
            ...
            if (error) throw error;
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`${newTables.length} mesas criadas com sucesso!`);
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Erro ao criar mesas em lote");
        } finally{
            setSaving(false);
        }
    };
    ...
    const handleDelete = async ()=>{
        ...
        try {
            ...
            if (error) throw error;
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Mesa excluída com sucesso!");
            setIsDeleteModalOpen(false);
            setDeleteTable(null);
            loadTables();
        } catch (error) {
            console.error('Error deleting table:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Erro ao excluir mesa");
        } finally{
            setSaving(false);
        }
    };
    ...
    const toggleActive = async (table)=>{
        try {
            ...
            if (error) throw error;
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Mesa ${!table.active ? 'ativada' : 'desativada'}`);
            loadTables();
        } catch (error) {
...
_s(TablesPage, "2DKVL1cIduDELDIji70qyOckyQQ=");
_c = TablesPage;
var _c;
...
//# sourceMappingURL=_14dee016._.js.map