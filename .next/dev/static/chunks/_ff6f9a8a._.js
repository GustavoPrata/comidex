...
"[project]/app/admin/virtual-printers/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function VirtualPrintersPage() {
    ...
    const [printerToDelete, setPrinterToDelete] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [tempConfig, setTempConfig] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [newPrinter, setNewPrinter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        name: '',
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "VirtualPrintersPage.useEffect": ()=>{
            const savedPrinters = localStorage.getItem('virtualPrinters');
            if (savedPrinters) {
                try {
                    const parsed = JSON.parse(savedPrinters);
                    setPrinters(parsed.map({
                        "VirtualPrintersPage.useEffect": (p)=>({
                                ...p,
                                queue: p.queue?.map({
                                    "VirtualPrintersPage.useEffect": (j)=>({
                                            ...j,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "VirtualPrintersPage.useEffect": ()=>{
            const interval = setInterval({
                "VirtualPrintersPage.useEffect.interval": ()=>{
                    setPrinters({
                        "VirtualPrintersPage.useEffect.interval": (prev)=>prev.map({
                                "VirtualPrintersPage.useEffect.interval": (p)=>({
                                        ...p,
                                        stats: {
                                            ...p.stats,
            ...
            }["VirtualPrintersPage.useEffect.interval"], 60000); // Atualiza a cada minuto
            return ({
                "VirtualPrintersPage.useEffect": ()=>clearInterval(interval)
            })["VirtualPrintersPage.useEffect"];
        }
    }["VirtualPrintersPage.useEffect"], []);
    ...
    const createPrinter = ()=>{
        ...
        if (printers.some((p)=>p.ipAddress === newPrinter.ipAddress && p.port === newPrinter.port)) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Já existe uma impressora com este IP e porta');
            return;
        }
        const printer = {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Impressora virtual criada!');
    };
    ...
    const confirmDelete = ()=>{
        if (printerToDelete) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Impressora virtual excluída');
    ...
    const togglePower = (printer)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Impressora ${!printer.powered ? 'ligada' : 'desligada'}`);
    };
    ...
    const testPrint = async (printer, type = 'test')=>{
        if (!printer.powered) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Impressora desligada! Ligue primeiro.');
            return;
        }
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Impressão enviada para ${printer.name}!`);
        setProcessing(null);
    };
    const clearQueue = (printerId)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Fila de impressão limpa!');
    };
    const exportToPDF = async ()=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('PDF gerado com sucesso!');
    };
    const updatePrinter = ()=>{
        ...
        if (duplicate) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Já existe outra impressora com este IP e porta');
            return;
        }
        ...
        setTempConfig(null);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Impressora atualizada!');
    };
    ...
    const saveConfig = ()=>{
        ...
        if (selectedPrinter) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Configurações salvas!');
        }
        setConfigModalOpen(false);
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                            onClick: ()=>{
                                                if (confirm('Isso irá resetar todas as impressoras virtuais para o padrão (incluindo Sushi Bar). Continuar?')) {
                                                    ...
                                                    initializeDefaultPrinters();
                                                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Impressoras virtuais resetadas com sucesso!');
                                                }
                                            },
                                            variant: "outline",
                                        ...
                                        printer.queue.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: printer.queue.slice(-3).map((job)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                    ...
                                    onClick: ()=>{
                                        ...
                                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Copiado para área de transferência!');
                                    },
                                    children: [
...
_s(VirtualPrintersPage, "/RvCCQJIZpD+Vt/C7bVvGC951wU=");
_c = VirtualPrintersPage;
var _c;
__turbopack_context__.k.register(_c, "VirtualPrintersPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_ff6f9a8a._.js.map