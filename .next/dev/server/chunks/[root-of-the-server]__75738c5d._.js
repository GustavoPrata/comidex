...
"[project]/app/api/printer-queue/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function DELETE(request, { params }) {
    try {
        ...
        const { data: job, error: fetchError } = await supabase.from('printer_queue').select('status').eq('id', jobId).single();
        if (fetchError || !job) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__75738c5d._.js.map