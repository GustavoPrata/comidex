...
async function checkPort(ip, port, timeout = 300) {
    return new Promise((resolve)=>{
        const socket = new __TURBOPACK__imported__module__$5b$externals$5d2f$net__$5b$external$5d$__$28$net$2c$__cjs$29$__["Socket"]();
        let resolved = false;
...
async function getPrinterInfo(ip, port) {
    return new Promise((resolve)=>{
        const socket = new __TURBOPACK__imported__module__$5b$externals$5d2f$net__$5b$external$5d$__$28$net$2c$__cjs$29$__["Socket"]();
        let resolved = false;
        const timeout = setTimeout(()=>{
            if (!resolved) {
                ...
                socket.destroy();
                resolve({
                    model: 'Impressora Térmica de Rede'
                });
            }
        }, 1500);
        ...
        socket.on('connect', ()=>{
            ...
            setTimeout(()=>{
                if (!resolved) {
                    ...
                    socket.destroy();
                    resolve({
                        model: 'Impressora Térmica ESC/POS'
                    });
                }
            }, 500);
        });
...
function getLocalSubnets() {
    const interfaces = __TURBOPACK__imported__module__$5b$externals$5d2f$os__$5b$external$5d$__$28$os$2c$__cjs$29$__["networkInterfaces"]();
...
async function scanSubnet(subnet, quickScan = false) {
    const foundPrinters = [];
    const promises = [];
...
async function checkSpecificIP(ip, ports) {
...
async function GET(request) {
    try {
        ...
        const uniquePrinters = allFoundPrinters.reduce((acc, printer)=>{
...
async function POST(request) {
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            message: foundPrinters.length > 0 ? `✅ ${foundPrinters.length} impressora(s) encontrada(s) em ${ip}` : `❌ Nenhuma impressora encontrada em ${ip}. Verifique se está ligada e na mesma rede.`
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ae3e3e5e._.js.map