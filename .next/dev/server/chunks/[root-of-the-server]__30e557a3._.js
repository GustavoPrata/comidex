...
"[project]/app/api/print-templates/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        let query = supabase.from('print_templates').select('*').order('template_type', {
            ascending: true
        }).order('name', {
            ascending: true
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__30e557a3._.js.map