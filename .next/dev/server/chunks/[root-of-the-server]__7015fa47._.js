...
"[project]/app/api/upload-product-image/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (productName && productName.trim() !== '') {
            ...
            baseName = productName.toLowerCase().normalize('NFD').replace(/[\u0300-\u036f]/g, '') // Remove accents
        ...
        const uploadDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'fotos', 'produtos');
...
async function DELETE(req) {
    try {
        ...
        const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', imagePath);
        try {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7015fa47._.js.map