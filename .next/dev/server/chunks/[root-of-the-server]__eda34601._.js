...
"[project]/app/api/mobile/tablet-settings/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const { data, error } = await supabase.from('tablet_settings').select('setting_key, setting_value, setting_type').order('id');
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eda34601._.js.map