...
"[project]/app/api/mobile/waiter-requests/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const { data, error } = await supabase.from('waiter_request_types').select('*').eq('active', true).order('sort_order', {
            ascending: true
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__df139740._.js.map