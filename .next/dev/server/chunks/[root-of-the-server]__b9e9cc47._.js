...
"[project]/app/api/mobile/call-waiter/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        let query = supabase.from('notifications').select('*').eq('type', 'waiter_call').order('created_at', {
            ascending: false
        }).limit(20);
        if (table_number) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b9e9cc47._.js.map