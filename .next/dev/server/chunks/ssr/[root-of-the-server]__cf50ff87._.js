...
"[project]/lib/database/postgres-client.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/database/adapter.ts [app-ssr] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2f$postgres$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/database/postgres-client.ts [app-ssr] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2f$postgres$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2f$postgres$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
function createClient() {
    return {
        from: (table)=>({
                select: async (columns)=>{
                    try {
                        ...
                        switch(table){
                            case 'groups':
                                result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2f$postgres$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getGroups"]();
                                break;
                            case 'categories':
                                result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2f$postgres$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCategories"]();
                                break;
                            case 'items':
                                result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2f$postgres$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getItems"]();
                                break;
                            case 'additionals':
                                result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2f$postgres$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAdditionals"]();
                                break;
                            case 'additional_categories':
                                result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2f$postgres$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAdditionalCategories"]();
                                break;
                            default:
                                queryText = columns ? `SELECT ${columns} FROM ${table} ORDER BY id` : `SELECT * FROM ${table} ORDER BY id`;
                                const queryResult = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2f$postgres$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"](queryText);
                ...
                insert: async (data)=>{
                    try {
                        const result = Array.isArray(data) ? await Promise.all(data.map((item)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2f$postgres$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["insert"](table, item))) : await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2f$postgres$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["insert"](table, data);
                        return {
                            data: result,
                            error: null
                        };
                ...
                update: async (data)=>({
                        eq: async (column, value)=>{
                            try {
                                if (column === 'id') {
                                    const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2f$postgres$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["update"](table, value, data);
                                    return {
                                        data: result,
                                        error: null
                                    };
              ...
              `;
                ...
                delete: async ()=>({
                        eq: async (column, value)=>{
                            try {
                                if (column === 'id') {
                                    const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2f$postgres$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["remove"](table, value);
                                    return {
                                        data: result,
                                        error: null
                                    };
                ...
                eq: (column, value)=>({
                        select: async (columns)=>{
                            try {
                                ...
                                const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2f$postgres$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"](queryText, [
                                    value
                                ]);
                                return {
                                    data: result.rows,
                ...
                in: (column, values)=>({
                        select: async (columns)=>{
                            try {
                                ...
                                const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2f$postgres$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"](queryText, values);
                                return {
                                    data: result.rows,
                                    error: null
                                };
        ...
        // Testar conexão
        testConnection: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2f$postgres$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["testConnection"]
    };
}
;
__turbopack_async_result__();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2f$adapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/lib/database/adapter.ts [app-ssr] (ecmascript) <locals>");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2f$adapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2f$adapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
function createClient() {
    console.log('🔌 Usando conexão PostgreSQL direta');
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2f$adapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])();
}
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cf50ff87._.js.map