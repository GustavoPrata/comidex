                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                ...
                                                                children: (()=>{
                                                                    ...
                                                                    if (cart.length > 0) {
                                                                        ...
                                                                        const rodizioGroup = groupsInCart.find((g)=>g.type === 'rodizio' || g.name?.toLowerCase().includes('rodizio') || g.name?.toLowerCase().includes('rodízio'));
                                                                        if (rodizioGroup) {
                                                                            return `${rodizioGroup.name}`;
                                                                        }
                                                                        // Prioridade 2: À la Carte
                                                                        const carteGroup = groupsInCart.find((g)=>g.name?.toLowerCase().includes('carte') || g.name?.toLowerCase().includes('la carte') || g.name?.toLowerCase().includes('à la carte'));
                                                                        if (carteGroup) {
