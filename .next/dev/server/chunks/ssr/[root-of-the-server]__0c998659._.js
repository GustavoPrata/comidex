...
"[project]/app/admin/additionals/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SortableAdditionalItem({ additional, onDuplicate, onEdit, onDelete, onToggleActive }) {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: `text-sm font-medium ${additional.price === 0 ? 'text-green-600 dark:text-green-400' : 'text-gray-900 dark:text-gray-100'}`,
                                    children: additional.price === 0 ? 'Grátis' : `R$ ${additional.price.toFixed(2).replace('.', ',')}`
                                }, void 0, false, {
                                    fileName: "[project]/app/admin/additionals/page.tsx",
                                    lineNumber: 121,
                                    columnNumber: 13
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        className: `w-16 px-3 py-1 text-xs font-medium rounded-full transition-colors ${additional.active ? 'bg-green-600 hover:bg-green-700 text-white' : 'bg-gray-500 hover:bg-gray-600 text-white'}`,
                        children: additional.active ? 'Ativo' : 'Inativo'
                    }, void 0, false, {
                        fileName: "[project]/app/admin/additionals/page.tsx",
                        lineNumber: 130,
                        columnNumber: 9
...
function AdditionalsPage() {
    ...
    const [isDeleteCategoryModalOpen, setIsDeleteCategoryModalOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const [editingAdditional, setEditingAdditional] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [deleteAdditional, setDeleteAdditional] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const [deleteCategory, setDeleteCategory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const loadData = async ()=>{
        ...
        try {
            // Load categories
            const { data: categoriesData, error: categoriesError } = await supabase.from('additional_categories').select('*').order('sort_order', {
                ascending: true
            });
            if (categoriesError) {
    ...
    const filteredAdditionals = additionals.filter((additional)=>additional.name.toLowerCase().includes(searchTerm.toLowerCase()));
    // Group additionals by category - including empty categories
    const groupedAdditionals = categories.reduce((acc, category)=>{
        const categoryName = category.name;
        const categoryItems = filteredAdditionals.filter((a)=>a.additional_category_id === category.id);
        acc[categoryName] = {
            category,
            items: categoryItems
        };
    ...
    const itemsWithoutCategory = filteredAdditionals.filter((a)=>!a.additional_category_id || !categories.find((c)=>c.id === a.additional_category_id));
    ...
    const handleDragEnd = async (event, categoryId)=>{
        ...
        if (active.id !== over?.id) {
            const categoryAdditionals = additionals.filter((a)=>a.additional_category_id?.toString() === categoryId).sort((a, b)=>(a.sort_order || 0) - (b.sort_order || 0));
            ...
            if (oldIndex !== -1 && newIndex !== -1) {
                const newOrder = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$sortable$2f$dist$2f$sortable$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["arrayMove"])(categoryAdditionals, oldIndex, newIndex);
                ...
                // Update database
                try {
                    const updates = newOrder.map((item, index)=>supabase.from('additionals').update({
                            sort_order: index
                        }).eq('id', item.id));
                    await Promise.all(updates);
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Ordem atualizada com sucesso!");
                } catch (error) {
                    console.error('Erro ao atualizar ordem:', error);
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Erro ao atualizar ordem");
    ...
    const duplicateCategory = async (category)=>{
        try {
            ...
            const { data: newCategoryData, error: categoryError } = await supabase.from('additional_categories').insert(newCategory).select().single();
            if (categoryError) {
                throw categoryError;
            }
            ...
            if (categoryAdditionals.length > 0) {
                ...
                const { data: newAdditionalsData, error: additionalsError } = await supabase.from('additionals').insert(newAdditionals).select();
                if (additionalsError) {
                    console.error('Erro ao duplicar adicionais:', additionalsError);
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Erro ao duplicar alguns adicionais");
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(`Categoria "${category.name}" duplicada com ${categoryAdditionals.length} itens!`);
        } catch (error) {
            console.error('Erro ao duplicar categoria:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Erro ao duplicar categoria");
        }
    };
    // Save additional
    const saveAdditional = async ()=>{
        try {
            ...
            if (editingAdditional) {
                const { data, error } = await supabase.from('additionals').update(additionalData).eq('id', editingAdditional.id).select().single();
                if (error) throw error;
                // Update local state
                setAdditionals((prev)=>prev.map((item)=>item.id === editingAdditional.id ? data : item).sort((a, b)=>{
                        if (a.additional_category_id === b.additional_category_id) {
                            return (a.sort_order || 0) - (b.sort_order || 0);
                        }
                        return 0;
                    }));
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Adicional atualizado com sucesso!");
            } else {
                const { data, error } = await supabase.from('additionals').insert(additionalData).select().single();
                if (error) throw error;
                // Update local state
                setAdditionals((prev)=>[
                        ...prev,
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Adicional criado com sucesso!");
            }
    ...
    const saveCategory = async ()=>{
        try {
            ...
            if (editingCategory) {
                const { data, error } = await supabase.from('additional_categories').update(categoryData).eq('id', editingCategory.id).select().single();
                if (error) throw error;
                // Update local state
                setCategories((prev)=>prev.map((item)=>item.id === editingCategory.id ? data : item).sort((a, b)=>(a.sort_order || 0) - (b.sort_order || 0)));
                ...
                const { data, error } = await supabase.from('additional_categories').insert(categoryData).select().single();
                if (error) throw error;
                // Update local state
                setCategories((prev)=>[
                        ...prev,
    ...
    const handleDelete = async ()=>{
        ...
        try {
            setSaving(true);
            const { error } = await supabase.from('additionals').delete().eq('id', deleteAdditional.id);
            if (error) throw error;
            // Update local state
            setAdditionals((prev)=>prev.filter((item)=>item.id !== deleteAdditional.id));
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Adicional excluído com sucesso!");
            setIsDeleteModalOpen(false);
            setDeleteAdditional(null);
        } catch (error) {
            console.error('Erro ao excluir adicional:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Erro ao excluir adicional");
        } finally{
            setSaving(false);
        }
    };
    ...
    const handleDeleteCategory = async ()=>{
        ...
        try {
            ...
            if (additionalsInCategory.length > 0) {
                const { error: deleteAdditionalsError } = await supabase.from('additionals').delete().eq('additional_category_id', deleteCategory.id);
            ...
            const { error } = await supabase.from('additional_categories').delete().eq('id', deleteCategory.id);
            if (error) throw error;
            // Update local state - remove category
            setCategories((prev)=>prev.filter((item)=>item.id !== deleteCategory.id));
            if (additionalsInCategory.length > 0) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(`Categoria "${deleteCategory.name}" e ${additionalsInCategory.length} itens excluídos!`);
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Categoria excluída com sucesso!");
            }
            setIsDeleteCategoryModalOpen(false);
            setDeleteCategory(null);
        } catch (error) {
            console.error('Erro ao excluir categoria:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Erro ao excluir categoria");
        } finally{
            setSaving(false);
        }
    };
    // Toggle active status
    const toggleActive = async (additional)=>{
        try {
            const newStatus = !additional.active;
            const { error } = await supabase.from('additionals').update({
                active: newStatus
            }).eq('id', additional.id);
            if (error) throw error;
            // Update local state
            setAdditionals((prev)=>prev.map((item)=>item.id === additional.id ? {
                        ...item,
                        active: newStatus
                    } : item));
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(`Adicional ${newStatus ? 'ativado' : 'desativado'}`);
        } catch (error) {
    ...
    const duplicateAdditional = async (additional)=>{
        try {
            // Find all items in the same category sorted by sort_order
            const categoryAdditionals = additionals.filter((a)=>a.additional_category_id === additional.additional_category_id).sort((a, b)=>(a.sort_order || 0) - (b.sort_order || 0));
            ...
            const { data, error } = await supabase.from('additionals').insert(newAdditional).select().single();
            if (error) throw error;
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Adicional duplicado com sucesso!");
        } catch (error) {
            console.error('Erro ao duplicar adicional:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Erro ao duplicar adicional");
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: Object.entries(groupedAdditionals).map(([categoryName, group])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Card"], {
                            ...
                            children: [
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "w-2 h-10 bg-gradient-to-b from-orange-500 to-orange-600 rounded-full"
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/admin/additionals/page.tsx",
                                                        lineNumber: 837,
                                                        columnNumber: 23
                                            ...
                                            group.category && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardContent"], {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "h-[280px] overflow-y-auto pr-1 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-thumb]:bg-gray-600 [&::-webkit-scrollbar-thumb]:rounded-full",
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$core$2f$dist$2f$core$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DndContext"], {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$sortable$2f$dist$2f$sortable$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SortableContext"], {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "space-y-2",
                                                        children: group.items.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            lineNumber: 890,
                                                            columnNumber: 29
                                                        }, this) : group.items.map((additional)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(SortableAdditionalItem, {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    ...
                                                    className: `w-full py-2 px-4 rounded-lg font-medium transition-all ${formData.active ? 'bg-green-100 text-green-700 hover:bg-green-200 dark:bg-green-900/30 dark:text-green-400 dark:hover:bg-green-900/40' : 'bg-gray-100 text-gray-700 hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700'}`,
                                    ...
                                    children: [
                                        ...
                                        deleteCategory && (()=>{
                                            ...
                                            return count > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "block mt-2 font-semibold text-destructive",
                                                children: [
                                                    "⚠️ Todos os ",
                                                    count,
                                                    " ",
                                                    count === 1 ? 'item' : 'itens',
                                                    " dentro desta categoria também serão excluídos!"
                                                ]
                                            }, void 0, true, {
                                                fileName: "[project]/app/admin/additionals/page.tsx",
                                                lineNumber: 1140,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0c998659._.js.map