...
"[project]/app/api/pos/orders-by-table/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        *,
        order_items(*)
      `).eq('table_id', table_id).in('status', [
            'pending',
            'confirmed',
            'preparing'
        ]).order('created_at', {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__be901448._.js.map