...
"[project]/app/api/printer-queue/clear/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { data, error } = await supabase.from('printer_queue').delete().in('status', [
            'pending',
            'printing'
        ]).select();
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a1c9edff._.js.map