...
async function GET() {
    try {
        const { data: categories, error } = await supabase.from('categories').select('*').eq('active', true).order('order_index', {
            ascending: true
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7de5e817._.js.map