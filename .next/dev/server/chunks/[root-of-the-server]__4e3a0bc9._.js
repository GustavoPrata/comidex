...
"[project]/app/api/upload-category-image/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (categoryName && categoryName.trim() !== '') {
            ...
            baseName = categoryName.toLowerCase().normalize('NFD').replace(/[\u0300-\u036f]/g, '') // Remove accents
        ...
        const uploadDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'fotos', 'categorias');
        ...
        while(true){
            try {
                await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["access"])(filePath);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4e3a0bc9._.js.map