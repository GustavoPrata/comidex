...
"[project]/app/api/admin/waiter-requests/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const { data, error } = await supabase.from('waiter_request_types').select('*').order('sort_order', {
            ascending: true
        });
...
async function POST(request) {
    try {
        ...
        const { data, error } = await supabase.from('waiter_request_types').insert({
            name,
...
async function PUT(request) {
    try {
        ...
        const { data, error } = await supabase.from('waiter_request_types').update({
            name,
            description,
            icon,
            color,
...
async function DELETE(request) {
    try {
        ...
        const { error } = await supabase.from('waiter_request_types').delete().eq('id', id);
        if (error) throw error;
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fdf5dc88._.js.map