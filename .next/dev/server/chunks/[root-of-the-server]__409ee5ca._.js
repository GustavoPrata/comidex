...
async function simulatePrintTest(printer) {
...
async function POST(request) {
    try {
        ...
        await supabase.from('printers').update(updateData).eq('id', printerId);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(testResult);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__409ee5ca._.js.map