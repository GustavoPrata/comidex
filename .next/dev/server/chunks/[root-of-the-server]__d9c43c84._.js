...
"[project]/app/api/promocoes/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        let query = supabase.from('promotions').select('*').order('priority', {
            ascending: false
        });
        if (active) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d9c43c84._.js.map